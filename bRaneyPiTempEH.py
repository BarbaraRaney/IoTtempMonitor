...
try:
	...
	sbs.send_event('iothub-ehub-raneynewio-110672-0405ae12a9', msg)
#   In the Event Hub, there is a built-in Endpoint which can serve as an Event Hub Compatible Name
